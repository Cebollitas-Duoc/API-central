...
urlpatterns = [
    ...
    path('editmaintenance/',              views.EditMaintenance,   name="EditMaintenance"),
    path('listmaintenance/<int:idDpto>/', views.ListMaintenance,   name="ListMaintenance"),
    path('deletemaintenance/',            views.DeleteMaintenance, name="DeleteMaintenance"),
]